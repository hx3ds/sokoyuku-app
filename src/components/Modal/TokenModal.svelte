            ...
            >
                {#snippet end()}
                    <div style="padding-right: 0.5rem;">
                        <Button variant="icon-button" onclick={copyToken} aria-label={copyButtonAriaLabel} title="Copy to clipboard">
            ...
            <InfoStackItem>
                {#snippet actions()}
                    <div style="display: flex; gap: 0.5rem;">
                        {#if onRefresh}
                            <Button variant="text-button" onclick={onRefresh}>{refreshLabel}</Button>
                        {/if}
                        {#if onSave}
                        ...
                        {/if}
                        <Button variant="text-button" onclick={close} aria-label={doneLabel}>
                            {doneLabel}
                        </Button>
                    </div>
                {/snippet}
